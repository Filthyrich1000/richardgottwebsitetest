...
FinancialDashboard.prototype.init = function() {
    console.log('Initializing dashboard with TradingView charts...');
...
FinancialDashboard.prototype.loadSampleData = function() {
    ...
    var baseTime = new Date('2024-01-01').getTime() / 1000; // Unix timestamp
...
FinancialDashboard.prototype.createCharts = function() {
    ...
    try {
        ...
        this.charts.sma5Line = this.charts.movingAverages.addLineSeries({ color: '#ff1744', lineWidth: 2, title: '5-day SMA' });
        this.charts.ema10Line = this.charts.movingAverages.addLineSeries({ color: '#9c27b0', lineWidth: 2, title: '10-day EMA' });
        this.charts.ema21Line = this.charts.movingAverages.addLineSeries({ color: '#2196f3', lineWidth: 2, title: '21-day EMA' });
        this.charts.sma35Line = this.charts.movingAverages.addLineSeries({ color: '#4caf50', lineWidth: 2, title: '35-day SMA' });
        this.charts.sma50Line = this.charts.movingAverages.addLineSeries({ color: '#000000', lineWidth: 2, title: '50-day SMA' });
        this.charts.sma200Line = this.charts.movingAverages.addLineSeries({ color: '#ffc107', lineWidth: 2, title: '200-day SMA' });
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM loaded, initializing TradingView dashboard...');
    window.dashboard = new FinancialDashboard();
    console.log('TradingView dashboard created successfully');
});